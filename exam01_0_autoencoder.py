...
encoded = Dense(32, activation='relu')# 줄이는 과정을 따로 시작한다, 지금까지는 sequencial 에 add를 했지만
encoded = encoded(input_img)
decoded = Dense(784, activation='sigmoid') # 0~ 1 사이의 값 출력 , 784층이 있다
decoded = decoded(encoded) # 32개의 입력을 받아 784개의 출력을 받는다.
